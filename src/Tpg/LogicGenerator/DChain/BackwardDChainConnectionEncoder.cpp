...
BackwardDChainConnectionEncoder<PinData>::BackwardDChainConnectionEncoder(void) = default;

template<typename PinData>
BackwardDChainConnectionEncoder<PinData>::~BackwardDChainConnectionEncoder(void) = default;

template<typename PinData>
std::string BackwardDChainConnectionEncoder<PinData>::GetName(void) const
{
	return "BackwardDChainConnectionEncoder";
}

template<typename PinData>
bool BackwardDChainConnectionEncoder<PinData>::EncodeTimeframe(GeneratorContext<PinData>& context, size_t timeframeId)
{
...
#define FOR_CONTAINER(CONTAINER) template class BackwardDChainConnectionEncoder<PinDataGBD<CONTAINER>>;
