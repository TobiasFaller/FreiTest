...
#ifndef BOOST_PROPERTY_TREE_DETAIL_JSONC_PARSER_WIDE_ENCODING_HPP
#define BOOST_PROPERTY_TREE_DETAIL_JSONC_PARSER_WIDE_ENCODING_HPP
    ...
    namespace jsonc_parser { namespace detail
{
    ...
    struct external_wide_encoding
    {
        ...
        bool is_star(wchar_t c) const { return c == L'*'; }
