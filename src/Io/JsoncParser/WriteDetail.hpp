...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_DETAIL_JSONC_PARSER_WRITE_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_DETAIL_JSONC_PARSER_WRITE_HPP_INCLUDED
...
namespace boost { namespace property_tree { namespace jsonc_parser
{
    ...
    template<class Ptree>
    void write_jsonc_internal(std::basic_ostream<typename Ptree::key_type::value_type> &stream,
                             const Ptree &pt,
