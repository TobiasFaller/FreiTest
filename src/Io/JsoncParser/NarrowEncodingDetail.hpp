...
#ifndef BOOST_PROPERTY_TREE_DETAIL_JSONC_PARSER_NARROW_ENCODING_HPP
#define BOOST_PROPERTY_TREE_DETAIL_JSONC_PARSER_NARROW_ENCODING_HPP
    ...
    namespace jsonc_parser { namespace detail
{
    ...
    struct external_ascii_superset_encoding
    {
		...
		bool is_star(char c) const { return c == '*'; }
