...
#ifndef BOOST_PROPERTY_TREE_DETAIL_JSONC_PARSER_READ_HPP
#define BOOST_PROPERTY_TREE_DETAIL_JSONC_PARSER_READ_HPP
...
#include "Io/JsoncParser/ParserDetail.hpp"
#include "Io/JsoncParser/NarrowEncodingDetail.hpp"
#include "Io/JsoncParser/WideEncodingDetail.hpp"

namespace boost { namespace property_tree {
    namespace jsonc_parser { namespace detail
{
    template <typename Ptree>
	using standard_callbacks = json_parser::detail::standard_callbacks<Ptree>;
    ...
    void read_jsonc_internal(Iterator first, Sentinel last, Encoding& encoding,
        ...
        Ptree &pt, const std::string &filename)
    {
        ...
        read_jsonc_internal(iterator(stream), iterator(),
